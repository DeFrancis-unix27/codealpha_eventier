...
urlpatterns = [
    ...
    path("list_events/", views.EventListView.as_view()),
    path("allpub_events/", views.PublishedEventListView.as_view()),
    path("allcomp_events/", views.CompeletedEventListView.as_view()),
    path("allcancel_events/", views.CancelledEventListView.as_view()),
    path("allpost_events/", views.PostponedEventListView.as_view()),
    path("alldraft_events/", views.DraftEventListView.as_view()),
